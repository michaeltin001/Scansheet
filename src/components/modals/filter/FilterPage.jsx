...
const FilterPage = ({
    ...
    return (
        ...
        >
            ...
            <h1 className="text-3xl font-bold mb-6 text-center text-[var(--theme-text)]">Filter By</h1>
            <p className="text-lg text-[var(--theme-text)] opacity-75 text-center mb-8">
                Please choose an option.
            </p>
            <div className="w-full max-w-sm flex flex-col gap-4">
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <md-outlined-button onClick={onDayFilter} class="w-full">
                        Filter By Day
                    </md-outlined-button>
                </motion.div>
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <md-outlined-button onClick={onCategoryFilter} class="w-full">
                        Filter by Category
                    </md-outlined-button>
                </motion.div>
            </div>
