...
const EditEntryPage = ({ statusMessage, setStatusMessage, onClose, entry, onUpdate }) => {
    ...
    return (
        ...
        >
            ...
            <h1 className="text-3xl font-bold mb-6 text-center text-[var(--theme-text)]">Edit Entry</h1>
