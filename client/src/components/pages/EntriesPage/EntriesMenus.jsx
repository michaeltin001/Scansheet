    ...
    return (
        <>
            ...
            >
                <ul className="py-1">
                    <li>
                        <a href="#" onClick={(e) => { e.preventDefault(); openNewEntryModal(); closeAddMenu(); }} className="flex items-center gap-3 px-4 py-2 text-sm text-[var(--theme-text)] hover:bg-[var(--theme-highlight)]">
                 ...
                 <ul className="py-1">
                    <li>
                        <a
                            ...
                            className={`flex items-center gap-3 px-4 py-2 text-sm text-[var(--theme-text)] ${selectedEntriesCount > 0 ? 'hover:bg-[var(--theme-highlight)]' : 'opacity-50 cursor-not-allowed'}`}
                        >
