...
const NewEntryPage = ({ statusMessage, setStatusMessage, onClose, onSuccess }) => {
    ...
    return (
        ...
        >
            ...
            <h1 className="text-3xl font-bold mb-6 text-center text-[var(--theme-text)]">Create New Entry</h1>
