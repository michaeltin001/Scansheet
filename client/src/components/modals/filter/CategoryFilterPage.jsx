...
const CategoryFilterPage = ({ onBack, onClose, allCategories, selectedCategories, setSelectedCategories, showBackButton = false }) => {
    ...
    useEffect(() => {
        if (clearSelectionButtonRef.current) {
            clearSelectionButtonRef.current.disabled = selectedCategories.size === allCategories.length;
        }
    ...
    const isAllCategoriesSelected = selectedCategories.size === allCategories.length;
    let shadowClass = '';
        ...
        >
            <div className="relative flex justify-center items-center mb-6">
                <div className="absolute left-0 flex items-center gap-2">
                    ...
                    <motion.div
                        whileHover={!isAllCategoriesSelected ? { scale: 1.05 } : {}}
                        whileTap={!isAllCategoriesSelected ? { scale: 0.95 } : {}}
                    >
                ...
                <h1 className="text-3xl font-bold text-[var(--theme-text)] text-center">Filter By Category</h1>
