...
const PrintBadgesPage = ({
    ...
    return (
        ...
        >
            ...
            <h1 className="text-3xl font-bold mb-6 text-center text-[var(--theme-text)]">Print Badges</h1>
            <p className="text-lg text-[var(--theme-text)] opacity-75 text-center mb-8">
                Please choose a print option.
            </p>
            <div className="w-full max-w-sm flex flex-col gap-4">
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <md-filled-button onClick={onPrintCurrent} class="w-full">
                        Print Selected on Current Page (Default)
                    </md-filled-button>
                </motion.div>
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <md-outlined-button onClick={onPrintSelected} class="w-full">
                        Print Selected Across All Pages
                    </md-outlined-button>
                </motion.div>
            </div>
        </div>
...
export default PrintBadgesPage;
